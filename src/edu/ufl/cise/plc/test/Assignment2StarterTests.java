...
class Assignment2StarterTests {
	...
	public void testAllOperators(TestInfo testInfo) throws Exception {
		...
		show(ast);
		assertThat("", ast, instanceOf(BinaryExpr.class));
		assertEquals(IToken.Kind.EQUALS, ((BinaryExpr) ast).getOp().getKind());

		Expr paren = ((BinaryExpr) ast).getLeft();
		assertThat("", paren, instanceOf(BinaryExpr.class));
		assertEquals(IToken.Kind.OR, ((BinaryExpr) paren).getOp().getKind());
		...
		assertEquals(IToken.Kind.GE, ((BinaryExpr) ge).getOp().getKind());
		...
		assertEquals(IToken.Kind.DIV, ((BinaryExpr) div).getOp().getKind());
		...
		assertEquals(IToken.Kind.MOD, ((BinaryExpr) mod).getOp().getKind());
	...
	public void triple_if(TestInfo testInfo) throws Exception {
		...
		Expr var17 = ((ConditionalExpr) ast).getCondition();
		assertThat("", var17, instanceOf(BinaryExpr.class));
		assertEquals(IToken.Kind.LT, ((BinaryExpr) var17).getOp().getKind());
		...
		assertEquals(IToken.Kind.GT, ((BinaryExpr) var25).getOp().getKind());
		...
		assertEquals(IToken.Kind.EQUALS, ((BinaryExpr) var29).getOp().getKind());
	...
	public void complex_unary(TestInfo testInfo) throws Exception{
		...
		show(ast);
		assertThat("", ast, instanceOf(BinaryExpr.class));
		assertEquals(IToken.Kind.OR, ((BinaryExpr) ast).getOp().getKind());

		Expr left1 = ((BinaryExpr) ast).getLeft();
		assertEquals(IToken.Kind.LT, ((BinaryExpr) left1).getOp().getKind());

		Expr right1 = ((BinaryExpr) ast).getRight();
		assertEquals(AND, ((BinaryExpr) right1).getOp().getKind());

		Expr final_ = ((BinaryExpr) right1).getLeft();
		assertEquals(IToken.Kind.NOT_EQUALS, ((BinaryExpr) final_).getOp().getKind());
